...
export class AlbumsService {
    ...
    public searchAlbum(query: string): Observable<Array<Album>> {
        ...
        return this.http.get(`${ENDPOINT}search?q=${query}&type=album`, { headers: paramHeader, observe: "response"})
            .map((res: HttpResponse<any>) => res.body)
            .map((res: any) => res.albums.items.map(i => new Album(i)));
    }
